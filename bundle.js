(() => {
  ...
  function varInt(n) {
    ...
    if (n <= 65535) return Uint8Array.of(253, n & 255, n >> 8);
    throw new Error("Message too long");
  }
  function concatBytes2(...arrays) {
    return Uint8Array.from(arrays.flatMap((a) => [...a]));
  }
  window.signCloreMessage = async function(privateKeyWIF, cloreAddress, evmAddress) {
    if (!privateKeyWIF || !cloreAddress || !evmAddress) {
      throw new Error("Missing inputs");
    }
    const { privateKey } = decode(privateKeyWIF);
